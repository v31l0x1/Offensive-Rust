...
use windows_sys::{
    ...
    Win32::{
        Foundation::{CloseHandle, PAPCFUNC, STATUS_INFO_LENGTH_MISMATCH},
        System::{
            ...
            Threading::{
                ...
                PROCESS_VM_READ, PROCESS_VM_WRITE, QUEUE_USER_APC_FLAGS_SPECIAL_USER_APC,
                QueueUserAPC2, THREAD_SET_CONTEXT,
            },
